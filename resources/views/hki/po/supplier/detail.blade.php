                    ...
                    <div style="text-align: left" class="row">
                        ...
                        <div class="col col-md-12 col-12 mt-2">
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control @error('delivery_time') is-invalid @enderror" id="delivery_time" name="delivery_time" placeholder="Masukkan delivery_time" value="{{$PO->delivery_time}}" readonly>
                                @error('delivery_time')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="col col-md-12 col-12 mt-2">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('payment') is-invalid @enderror" id="payment" name="payment" placeholder="Masukkan payment" value="{{$PO->payment}}" readonly>
                                @error('payment')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
