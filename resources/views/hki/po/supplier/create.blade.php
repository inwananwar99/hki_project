...
<div class="container">
    <div class="card">
        <div class="xformdm">
            ...
            <div class="form mt-4">
                <form enctype="multipart/form-data" action="{{route('hki.po.supplier.store')}}" method="POST" >
                    @csrf
                    <div style="text-align: left" class="row">
                        <div class="col col-md-12 col-12 mt-2">
                            <div class="form-group">
                                <label for="level">Supplier Tujuan</label>
                        ...
                        <div class="col col-md-12 col-12 mt-2">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control @error('order_no') is-invalid @enderror" id="order_no" name="order_no" placeholder="Masukkan order_no" value="{{old('order_no')}}">
                                @error('order_no')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
