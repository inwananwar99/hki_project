                        ...
                        <div class="col col-md-6 mt-2">
                            <div class="col col-md-12 col-12 mt-2">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('nama') is-invalid @enderror" id="nama" name="nama" placeholder="Masukkan Nama User" value="{{$user->nama}}">
                                    @error('nama')
                            ...
                            <div class="col col-md-12 col-12 mt-2">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('username') is-invalid @enderror" id="username" name="username" placeholder="Masukkan Username" value="{{$user->username}}" readonly>
                                    @error('username')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="col col-md-12 col-12 mt-2">
                                <div class="form-group">
                                    ...
                                    <select name="role_id" class="form-control @error('role_id') is-invalid @enderror">
                                        ...
                                        <option value="{{$data->role_id}}" @if($user->role_id == $data->role_id) selected @endif>{{$data->role_name}}</option>
                                        @endforeach
                                    </select>
                                    @error('role_id')
                                    <span class="invalid-feedback" role="alert">
                        ...
                        <div class="col col-md-6 mt-2">
                            ...
                            <div class="col col-md-12 col-12 mt-2">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('telepon') is-invalid @enderror" id="telepon" name="telepon" placeholder="Masukkan telepon" value="{{$user->telepon}}">
                                    @error('telepon')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="col col-md-12 col-12 mt-2">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('fax') is-invalid @enderror" id="fax" name="fax" placeholder="Masukkan fax" value="{{$user->fax}}">
                                    @error('fax')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="col col-md-12 col-12 mt-2">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('attn') is-invalid @enderror" id="attn" name="attn" placeholder="Masukkan attn" value="{{$user->attn}}">
                                    @error('attn')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
